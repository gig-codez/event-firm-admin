...
const Landingpage = ({local_varaiable,ThemeChanger}:{local_varaiable:any,ThemeChanger:any}) => {
  const settings = {
    dots: false,
    infinite: true,
    slidesToShow: 1,
  ...
  const handleClick1 = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    e.preventDefault();
  ...
  useEffect(() => {
    ...
    pageLinks.forEach((elem) => {
      elem.addEventListener('click', handleClick1 as unknown as EventListener);
    });

    return () => {
      // Clean up event listeners when the component unmounts
      pageLinks.forEach((elem) => {
        elem.removeEventListener('click', handleClick1 as unknown as EventListener);
      });
    };
  }, []);
        ...
        <header className="app-header">
            ...
            <div className="main-header-container container-fluid">
                ...
                <div className="header-content-left">
                    ...
                    <div className="header-element">
                        <a href="#" className="sidemenu-toggle header-link" data-bs-toggle="sidebar" onClick={() => toggleNavigation()}>
                ...
                <div className="header-content-right">
                    ...
                    <div className="header-element align-items-center">
                        <div className="btn-list d-lg-none d-block">
                            <a href="/components/authentication/signup/" className="btn btn-primary-light">
                                New User
                            </a>
                            <a href="/components/authentication/signin/" className="btn btn-primary-light">
                                Login
                            </a>
                        </div>
                    </div>
...
<div className="container p-0">
    <div className="main-sidebar">
        ...
        <nav className="main-menu-container nav nav-pills sub-open">
            ...
            <div className="slide-left d-none" id="slide-left"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24"> <path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"></path> </svg></div>
            <ul className="main-menu" style={{marginLeft: "0px",marginRight: "0px"}}>
                ...
                <li className="slide">
                    <a href="#highlights" className="side-menu__item">
                        <span className="side-menu__label">Highlights</span>
                    </a>
                </li>
          
                <li className="slide">
                    <a href="#faq" className="side-menu__item">
                        <span className="side-menu__label">Faqs</span>
                    </a>
                </li>
            
                <li className="slide">
                    <a href="#Clients" className="side-menu__item">
            ...
            <div className="d-lg-flex d-none">
                <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                    <Link href="/components/authentication/signup/" className="btn btn-wave btn-secondary">
                        New User
                    </Link>
                    <Link href="/components/authentication/signin/" className="btn btn-wave btn-info">
                        Login
                    </Link>
                </div>
            </div>
              ...
              <div className="landing-banner landing-top-header" id="home">
                <section className="section demo-screen-headline main-demo-1">
                    <div className="container main-banner-container">
                        <div className="row">
                            <div className="col-xl-6 col-lg-6 animation-zidex position-relative">
                                ...
                                <h6 className="pb-3">
                                    ...
                                    you need to start from scratch with Nextjs, SCSS, CSS, and TS and with lots of coding,
                                    but by using this Spruha-Admin template.</h6>
                                <div className="btn-list">
                                    <Link href="https://themeforest.net/user/spruko/portfolio" target="_blank" className="btn ripple btn-min w-lg mb-3 me-2 btn-light"><i className="fe fe-play me-2"></i> Get Started
                                    </Link>
            ...
            <section className="section hor-content main_features" id="features">
                <div className="container">
                    <div className="row">
                        ...
                        <h2 className="fw-medium text-center">Spruha Main Features</h2>
                        ...
                        <div className="row mt-7">
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-1 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-2 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-3 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-4 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-5 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-6 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-7 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="card features border text-center main-features main-features-8 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                    <div className="card-body">
                                        <div className="counter-body-2">
                                            <div className="bg-img mb-2 text-left hexagon-wrapper">
                                                <div className="counter-icon hexagon">
                                                                        ...
                                                                        <div className="bg-transparent">
                                                                            <div className="counter-status">
                                                                                ...
                                                                                <div className="test-body text-center text-fixed-white">
                                                                                    <h1 className=" mb-0">
                                                                                        <span className="counter fw-medium counter">100</span>
                                                                                        <span className="">+</span>
                                                                                    </h1>
                                                                    ...
                                                                    <div className="card reveal active">
                                                                        <div className="bg-transparent">
                                                                            <div className="counter-status">
                                                                                ...
                                                                                <div className="test-body text-center text-fixed-white">
                                                                                    <h1 className=" mb-0">
                                                                                        <span className="counter fw-medium counter">20</span>
                                                                                        <span className="">+</span>
                                                                                    </h1>
                                                                                    <div className="counter-text">
                                                                                        <h5 className="fw-normal mb-0">
                                                                    ...
                                                                    <div className="card reveal active">
                                                                        <div className="bg-transparent">
                                                                            <div className="counter-status">
                                                                                ...
                                                                                <div className="test-body text-center text-fixed-white">
                                                                                    <h1 className=" mb-0">
                                                                                        <span className="counter fw-medium counter">10</span>
                                                                                        <span className="">+</span>
                                                                                    </h1>
                                                                                    <div className="counter-text">
                                                                                        <h5 className="fw-normal mb-0">
                                                                    ...
                                                                    <div className="card reveal active">
                                                                        <div className="bg-transparent">
                                                                            <div className="counter-status">
                                                                                ...
                                                                                <div className="test-body text-center text-fixed-white">
                                                                                    <h1 className=" mb-0">
                                                                                        <span className="counter fw-medium counter">15</span>
                                                                                        <span className="">+</span>
                                                                                    </h1>
                                                                                    <div className="counter-text">
                                                                                        <h5 className="fw-normal mb-0">
...
C431.3,1830.2,378.4,1777.3,378.4,1712z"
                ...
                <div className="container text-center">
                    ...
                    <h4 className="fw-medium mb-2 text-fixed-white ">Features Used in Spruha Admin Template</h4>
                        ...
                        <div className="justify-content-center">
                            <div className="">
                                <div className="feature-logos mt-sm-5 flex-wrap">
                                    ...
                                    <div className="ms-sm-5 ms-3 text-center">
                                        <img src="../../../assets/landing/web/8.png" alt="image" className="featur-icon"/>
                ...
                <div className="container text-center">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-7">
                            <p className=" fs-15 mb-5 fw-normal">The Spruha – Nextjs Admin &amp; Dashboard
                        ...
                        <div className="col-xl-12">
                            <div className="row gy-2">
                                <div className="col-xl-6">
                                    <Accordion defaultActiveKey="0"  className="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ1">
                                        <Accordion.Item eventKey="0" className="accordion-item acc-primary" >
                                            ...
                                            Switch Easily From Vertical to Horizontal Menu
                                                ...
                                                <Accordion.Body className="accordion-body">
                                                    <p>
                                                        The Spruha – Nextjs Admin &amp; Dashboard
                                                        Template is available in both vertical and
                                                        horizontal menus.
                                                        Both menus are managed by single assets. Where
                                                        users can easily switch from vertical to
                                                    ...
                                                    <a href="#!" className="btn btn-outline-primary fs-13">Click
                                                        here</a>
                                                </Accordion.Body>
                                        </Accordion.Item>
                                        <Accordion.Item eventKey="1" className="accordion-item acc-secondary">
                                            <Accordion.Header className="accordion-header" id="headingcustomicon1Two">
                                                ...
                                                <Accordion.Body className="accordion-body">
                                                    ...
                                                    <a href="#!" className="btn btn-outline-pink fs-13">Click
                                                        here</a>
                                                </Accordion.Body>
                                        </Accordion.Item>
                                        <Accordion.Item eventKey="2" className="accordion-item acc-success">
                                            <Accordion.Header className="accordion-header" id="headingcustomicon1Three">
                                                ...
                                                <Accordion.Body className="accordion-body">
                                                    ...
                                                    <a href="#!" className="btn btn-outline-success fs-13">Click
                                                        here</a>
                                                </Accordion.Body>
                                        </Accordion.Item>
                                    </Accordion>
                                ...
                                <div className="col-xl-6">
                                    <Accordion defaultActiveKey="5"   className="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ20">
                                        <Accordion.Item  eventKey="3" className="accordion-item acc-info">
                                            <Accordion.Header className="accordion-header" id="headingcustomicon2Five">
                                                ...
                                                <Accordion.Body className="accordion-body">
                                                    ...
                                                    <a href="#!" className="btn btn-outline-info fs-13">Click
                                                        here</a>
                                                </Accordion.Body >
                                        </Accordion.Item >
                                        <Accordion.Item eventKey="4" className="accordion-item acc-danger">
                                            <Accordion.Header className="accordion-header" id="headingcustomicon2Six">
                                                ...
                                                <Accordion.Body className="accordion-body">
                                                    ...
                                                    <a href="#!" className="btn btn-outline-danger fs-13">Click
                                                        here</a>
                                                </Accordion.Body>
                                        </Accordion.Item>
                                        <Accordion.Item eventKey="5" className="accordion-item acc-warning">
                                            <Accordion.Header className="accordion-header" id="headingcustomicon2Four">
                                                ...
                                                <Accordion.Body className="accordion-body">
                                                    ...
                                                    <a href="#!" className="btn btn-outline-warning fs-13">Click
                                                        here</a>
                                                </Accordion.Body>
                                        </Accordion.Item>
                                    </Accordion>
  ...
  <Tab.Content>
    ...
    <div className="row d-flex align-items-center justify-content-center">
                                        <div className="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                            <div className="card pricing-card">
                                                <div className="card-header d-block text-justified py-3">
                                                    <p className="fs-18 fw-medium mb-1">Basic</p>
                                                    <p className="text-justify fw-medium mb-1"> <span className="fs-30 me-2">$</span><span className="fs-30 me-1">39</span><span className="fs-25"><span className="op-0-5 text-muted text-20">/</span>
                                                            month</span></p>
                                                ...
                                                <div className="card-body pt-2">
                                                    <ul className="text-justify pricing-body ps-0">
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline p-2 fs-16 text-secondary"></i><strong>
                                                                2 Free</strong> Domain Name</li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline p-2 fs-16 text-secondary"></i>
                                                            <strong>3 </strong> One-Click Apps
                                                        </li>
                                                        <li className="text-muted"><i className="mdi mdi-close-circle-outline p-2 fs-16 text-gray"></i><strong>
                                        ...
                                        <div className="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                            <div className="card border bg-primary border-primary pricing-card advanced reveal revealrotate active">
                                                <div className="p-3 d-block text-justified bd-b-white-2">
                                                    <p className="fs-18 fw-medium mb-1 pe-0">Advanced<span className="badge bg-white text-primary float-end fw-normal">Limited
                                                            Deal</span></p>
                                                    <p className="text-justify fw-medium mb-1"> <span className="fs-30 me-2">$</span><span className="fs-30 me-1">199</span><span className="fs-25"><span className="op-0-5 text-muted text-20">/</span>
                                                            month</span></p>
                                                ...
                                                <div className="card-body py-2">
                                                    <ul className="text-justify pricing-body ps-0 my-5">
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i>
                                                            <strong> 5 Free</strong> Domain Name
                                                        </li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i><strong>5
                                                            </strong> One-Click Apps</li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i><strong>
                                                                3 </strong> Databases</li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i><strong>
                                                                Unlimited </strong> Cloud Storage</li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i><strong>
                                                                Money </strong> BackGuarantee</li>
                                                        <li className=""><i className="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i><strong>
                                                                24/7</strong> support</li>
                                                    </ul>
                                                </div>
                                                <div className="text-center border-top-0 p-3 d-grid">
                                                    <button className="btn btn-lg btn-white text-primary">
                                                        <span className="ms-4 me-4">Select</span>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                            <div className="card pricing-card">
                                                <div className="card-header d-block text-justified py-3">
                                                    ...
                                                    <p className="text-justify fw-medium mb-1"> <span className="fs-30 me-2">$</span><span className="fs-30 me-1">69</span><span className="fs-25"><span className="op-0-5 text-muted text-20">/</span>
                                                            month</span></p>
                                                    <p className="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Iure quos debitis
                                                        aliquam .</p>
                                                ...
                                                <div className="card-body pt-2">
                                                    <ul className="text-justify pricing-body ps-0">
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-danger p-2 fs-16"></i><strong>
                                                                1 Free</strong> Domain Name</li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-danger p-2 fs-16"></i><strong>4
                                                            </strong> One-Click Apps</li>
                                                        <li><i className="mdi mdi-checkbox-marked-circle-outline text-danger p-2 fs-16"></i><strong>
                                                                2 </strong> Databases</li>
                                                        <li className="text-muted"><i className="mdi mdi-close-circle-outline text-gray p-2 fs-16"></i><strong>
                                                                Unlimited </strong> Cloud Storage</li>
                                                        <li className="text-muted"><i className="mdi mdi-close-circle-outline text-gray p-2 fs-16"></i><strong>
                                                                Money </strong> BackGuarantee</li>
                                                        <li className="text-muted"><i className="mdi mdi-close-circle-outline text-gray p-2 fs-16"></i><strong>
    ...
    <div className="row d-flex align-items-center justify-content-center">
                                        <div className="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                            <div className="card pricing-card reveal revealrotate active">
                                                <div className="card-header d-block text-justified py-3">
                                                    <p className="fs-18 fw-medium mb-1">Basic</p>
                                                    <p className="text-justify fw-medium mb-1"> <span className="fs-30 me-2">$</span><span className="fs-30 me-1">399</span><span className="fs-25"><span className="op-0-5 text-muted text-20">/</span>
                                                            year</span></p>
                                                    <p className="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Iure quos debitis
                                                        aliquam .</p>
                                        ...
                                        <div className="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                            <div className="card border bg-primary border-primary pricing-card advanced reveal revealrotate active">
                                                <div className="p-3 d-block text-justified bd-b-white-2">
                                                    <p className="fs-18 fw-medium mb-1 pe-0">Advanced<span className="badge bg-white text-primary float-end fw-normal">Limited
                                                            Deal</span></p>
                                                    <p className="text-justify fw-medium mb-1"> <span className="fs-30 me-2">$</span><span className="fs-30 me-1">1,299</span><span className="fs-25"><span className="op-0-5 text-muted text-20">/</span>
                                                            year</span></p>
                                                    <p className="fs-13 mb-2">Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Iure quos debitis
                                                        aliquam .</p>
                                        ...
                                        <div className="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                            <div className="card pricing-card reveal revealrotate active">
                                                <div className="card-header d-block text-justified py-3">
                                                    <p className="fs-18 fw-medium mb-1">Regular</p>
                                                    <p className="text-justify fw-medium mb-1"> <span className="fs-30 me-2">$</span><span className="fs-30 me-1">899</span><span className="fs-25"><span className="op-0-5 text-muted text-20">/</span>
                                                            year</span></p>
                                                    <p className="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Iure quos debitis
                                                        aliquam .</p>
            ...
            <section className="section highlights" id="faq">
                <div className="container">
                    <div className="row">
                        <h4 className="text-center fw-medium landing-card-header">FAQS ?</h4>
                        <span className="landing-title"></span>
                        <h2 className="text-center fw-medium">We are here to help you</h2>
                        <div className="row justify-content-center">
                            <p className="col-xl-9 wow fadeInUp text-default sub-text mb-5" data-wow-delay="0s">
                                The Spruha Nextjs admin template is one of the modern dashboard templates.
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-12 col-lg-6">
                                <Accordion defaultActiveKey="0" className="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ2">
                                    <Accordion.Item eventKey="0" className="accordion-item acc-primary">
                                        <Accordion.Header className="accordion-header" id="headingcustomicon20Five">
                                                <span className="me-3 fs-18 fw-bold">01.</span>Can i get a free trial before purchase ?
                                        </Accordion.Header>
                                            <Accordion.Body className="accordion-body">
                                                <p>
                                                ...
                                                <a href="#!" className="btn btn-outline-primary fs-13">Click here</a>
                                            </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="1" className="accordion-item acc-danger">
                                        <Accordion.Header className="accordion-header" id="headingcustomicon21Six">
                                                <span className="me-3 fs-18 fw-bold">02.</span>What type of files i will get after purchase ?
                                        </Accordion.Header>
                                            <Accordion.Body className="accordion-body">
                                                <p>
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                ...
                                                <a href="#!" className="btn btn-outline-danger fs-13">Click here</a>
                                            </Accordion.Body>
                                    </Accordion.Item >
                                    <Accordion.Item eventKey="2"  className="accordion-item acc-success">
                                        <Accordion.Header className="accordion-header" id="headingcustomicon22Six">
                                                <span className="me-3 fs-18 fw-bold">03.</span>What is a single Application
                                        </Accordion.Header>
                                            <Accordion.Body className="accordion-body">
                                                <p>
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                    ...
                                    <Accordion.Item  eventKey="3" className="accordion-item acc-secondary">
                                        <Accordion.Header className="accordion-header" id="headingcustomicon23Six">
                                                <span className="me-3 fs-18 fw-bold">04.</span>How to get future updates ?
                                        </Accordion.Header>
                                            <Accordion.Body className="accordion-body">
                                                <p>
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                ...
                                                <a href="#!" className="btn btn-outline-pink fs-13">Click here</a>
                                            </Accordion.Body>
                                            </Accordion.Item>
                                    <Accordion.Item eventKey="4" className="accordion-item acc-info">
                                        <Accordion.Header className="accordion-header" id="headingcustomicon24Six">
                                                <span className="me-3 fs-18 fw-bold">05.</span>Do you provide support ?
                                        </Accordion.Header>
                                            <Accordion.Body className="accordion-body">
                                                <p>
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                ...
                                                <a href="#!" className="btn btn-outline-info fs-13">Click here</a>
                                            </Accordion.Body>
                                    </Accordion.Item >
                                </Accordion>
                            </div>
                            <div className="col-md-12 col-lg-6 reveal revealright active">
                ...
                <div
                  className="section landing-testimonials section-bg px-3"
                  id="Clients"
                >
                  <Container>
                    <Row>
                      <Col md={12}>
                        <Card className="bg-transparent">
                          <Card.Body className="pt-5">
                            ...
                            <div className="testimonial-carousel file-details">
                            <Slider {...settings}>
                        ...
                        <div className="card-body text-dark p-4">
                            <div className="statistics-info">
                                <div className="row justify-content-center">
                                    <div className="col-lg-12">
                                        <div className="mt-3">
                                            <div className="text-dark">
                                                <div className="services-statistics reveal my-5 active">
                                    ...
                                    <div className="col-xl-12">
                                        <div className="">
                                            <form className="reveal active">
                                                <div className="row">
                                                    <div className="col-xl-6">
                                                        <div className="form-group ">
                                                            <label htmlFor="cusName" className="form-label">Name
                                                                <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" id="cusName" placeholder="Enter your name"/>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6">
                                                        <div className="form-group">
                                                            <label htmlFor="cusEmail" className="form-label">Email
                                                                <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" id="cusEmail" placeholder="Enter your email"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="cusSubject" className="form-label">Subject</label>
                                                    <input type="text" className="form-control" id="cusSubject" placeholder="Enter your subject"/>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="cusMessage" className="form-label">Message <span className="text-danger">*</span></label>
                                                    <textarea rows={5} className="form-control" id="cusMessage" placeholder="Type your message here..."></textarea>
                                                </div>
                                                <div className="form-group">
                    ...
                    <div className="p-2 mb-0">
                        <div className="card-body p-0">
                            <div className="top-footer">
                                <div className="row">
                                    <div className="col-lg-4 col-sm-12 col-md-12 reveal revealleft position-relative active">
                                        <h6>About</h6>
                                    ...
                                    <div className="col-lg-2 col-sm-6 col-md-4 reveal revealleft position-relative active">
                                        <h6>Information</h6>
                                        <ul className="mb-5 mb-lg-0 ps-0">
                                            <li><Link href="/components/elements/list-group/">Our Team</Link></li>
                                            <li><Link href="/components/advancedui/contacts/">Contact US</Link></li>
                                            <li><Link href="/components/pages/about-us/">About</Link></li>
                                            <li><Link href="/components/advancedui/search/">Services</Link></li>
                                            <li><Link href="/components/apps/blog/blog-page/">Blog</Link></li>
                                            <li><Link href="/components/pages/settings/">Terms and Services</Link></li>
                                        </ul>
                                    </div>
                                    <div className="col-lg-4 col-sm-12 col-md-4 reveal revealleft active">
                                        <div className="">
                                            <Link href="/components/dashboard/dashboard"><img loading="lazy" alt="" className="logo mb-3" src="../../../assets/images/brand-logos/desktop-white.png"/></Link>
                                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                                                dolore eu fugiat nulla pariatur Excepteur sint occaecat.</p>
                                            <div className="form-group">
                                                <div className="input-group">
                                                    <input type="text" className="form-control" placeholder="Enter your email" aria-label="Example text with button addon"/>
                                                    <button className="btn btn-primary" type="button" id="button-addon2">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="btn-list mt-6">
                                            <button type="button" className="btn btn-icon rounded-pill"><i className="fs-14 fe fe-facebook"></i></button>
                                            <button type="button" className="btn btn-icon rounded-pill"><i className="fs-14 fe fe-github"></i></button>
                                            <button type="button" className="btn btn-icon rounded-pill"><i className="fs-14 fe fe-twitter"></i></button>
                                            <button type="button" className="btn btn-icon rounded-pill"><i className="fs-14 fe fe-instagram"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <footer className="main-footer px-0 text-center">
                                <div className="row ">
                                    <div className="col-md-12 col-sm-12">
                                        Copyright © <span id="year">2024</span> <a href="#!">Spruha</a>.
                                        Designed with <span className="fa fa-heart text-danger"></span> by <a href="#!"> Spruko </a> All rights reserved.
                                    </div>
                                </div>
                            </footer>
                        </div>
