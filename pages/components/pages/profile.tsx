            ...
            <Col md={12} lg={12}>
              <div className="card custom-card main-content-body-profile">
                        ...
                        <div className="tab-content">
                          <div className="main-content-body tab-pane p-sm-4 p-0 border-top-0 active">
                            <div className=" p-0 border p-0 rounded-10">
                              ...
                              <div className="p-4">
                                <Form.Label className="main-content-label fs-13 mg-b-20">
                                  Contact
                                </Form.Label>
                              ...
                              <div className="p-3 p-sm-4">
                                ...
                                <div className="d-xl-flex">
                                  <div className="mg-md-r-20 me-2 mg-b-10">
                    ...
                    <div className="main-content-body tab-pane border-top-0">
                      <div className="">
                        <div className="main-content-body main-content-body-profile">
                          <div className="main-profile-body profile-dropdown p-0">
                            <Row className=" row-sm">
                              <div className="col-12">
                                <Card className=" mg-b-20 border">
                                  <Card.Header className="p-4 d-block">
                                    <div className="media">
                                      <div className="media-user me-2">
                                        <div className="main-img-user avatar-md">
                                          <img alt="user6" className="rounded-circle" src={ "../../../assets/images/faces/6.jpg"} />
                                        </div>
                                      </div>
                                      <div className="media-body">
                                  ...
                                  <Card.Body>
                                    ...
                                    <Row className=" row-sm">
                                      <div className="col">
                                        <img alt="img" className="wd-200 m-2" src={"../../../assets/images/media/media-4.jpg"} />
                                        <img alt="img" className="wd-200 m-2" src={"../../../assets/images/media/media-5.jpg"} />
                                      </div>
                                    </Row>
                                ...
                                <Card.Header className="p-4 d-block">
                                  ...
                                  <Card.Body>
                                    ...
                                    <Row className=" row-sm">
                                      <div className="col">
                                        <img alt="img" className="wd-200 m-2" src={"../../../assets/images/media/media-5.jpg"} />
                                        <img alt="img" className="wd-200 m-2" src={"../../../assets/images/media/media-12.jpg"} />
                                      </div>
                                    </Row>
                                    <div className="media mg-t-15 profile-footer">
                                      {/* <div className="media-user me-2">
                                ...
                                <Card.Header className="p-4 d-block">
                                    <div className="media">
                                      <div className="media-user me-2">
                                        <div className="main-img-user avatar-md">
                                          <img alt="user6" className="rounded-circle" src={ "../../../assets/images/faces/2.jpg"} />
                                        </div>
                                      </div>
                                      <div className="media-body">
                                        <h6 className="mb-0 mg-t-2 ms-2">
                                  ...
                                  <Card.Body className="h-100">
                                    ...
                                    <Row className="row row-sm">
                                      <div className="col">
                                        <img alt="img" className="wd-200 m-2" src={"../../../assets/images/media/media-9.jpg"} />
                                        <img alt="img" className="wd-200 m-2" src={"../../../assets/images/media/media-17.jpg"} /> </div>
                                    </Row>
                                    <div className="media mg-t-15 profile-footer">
                                    <div className="media-user me-2">
                                        <div className="avatar-list-stacked">
                ...
                <Gallery2/>
                  ...
                  <Tab.Pane eventKey="friends" className="main-content-body  border-top-0 p-0  ">
                        ...
                        <Form className="form-horizontal" data-select2-id="11">
                          ...
                          <FormGroup className="form-group">
                            <Row className=" row-sm">
                              <Col md={2}> </Col>
                              <Col md={10}>
                                <Link href="#!" className="mg-r-20 d-block d-sm-inline-flex">
                                  Deactivate Account
                                </Link>
                                <Link href="#!" className="m-0 mx-sm-2 d-block d-sm-inline-flex" >
                                  Change Password
                                </Link>
                              </Col>
                            </Row>
