...
//Images
import team from "../../../public/assets/images/media/team.jpg"
import users5 from "../../../public/assets/images/users/5.jpg"
import users6 from "../../../public/assets/images/users/6.jpg"
import users7 from "../../../public/assets/images/users/7.jpg"
import users8 from "../../../public/assets/images/users/8.jpg"
      ...
      <Row className="row-sm">
        <Col xl={12}>
          <Card className="custom-card">
            <img
              src={"../../../assets/images/media/jobs-landing/blog/16.jpg"}
              alt="img"
              className="rounded-2"
            />
          </Card>
          ...
          <Row className="row-sm">
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="mt-5">
                ...
                <Link href="#!" className="btn ripple btn-primary btn-sm mb-lg-0 mb-3" role="button">
					        Contact Us
                </Link>
              </div>
            </Col>
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="text-center">
                <img src={"../../../assets/images/pngs/28.png"} alt="img" className="rounded-5 w-50 h-50"/>
              </div>
            </Col>
          </Row>
        </Col>
