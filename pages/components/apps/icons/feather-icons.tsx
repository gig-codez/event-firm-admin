...
import { Breadcrumb, Card, Row, Col, Button, OverlayTrigger, Tooltip, } from "react-bootstrap";
import Seo from '../../../../shared/layout-components/seo/seo';

const FeatherIcons = () => {
  return (
    <>
        <Seo title="Feather Icons"/>

    <PageHeader title="Feather Icons" item="Icons" active_item="Feather Icons"/>
          ...
          <Card.Body>
            <Row className="row-sm">
              <Col lg={12} md={4} sm={12}>
                <h3 className="main-content-label">Feather Icons</h3>
                <p className="mb-2">
                  Simply beautiful open source icons. For more info
                  <a href="https://feathericons.com" target='blank'> click here
                  </a>
                  .
                </p>
                <p>
