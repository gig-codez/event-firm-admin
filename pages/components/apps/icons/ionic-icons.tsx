...
import { Breadcrumb, Button, Card, OverlayTrigger, Row, Tooltip, Col } from "react-bootstrap";
import Seo from '../../../../shared/layout-components/seo/seo';

const IonicIcons = () => {
  return (
    <>
        <Seo title="Ionic Icons"/>

    <PageHeader title="Ionic Icons" item="Icons" active_item="Ionic Icons"/>
    ...
    <Row className=" row-sm">
      <Col md={12}>
        <Card className="custom-card">
          <Card.Body>
            <Row className=" row-sm">
              <Col lg={12} sm={12} className="col-lg-12 col-sm-12 ">
                <h3 className="main-content-label">Ionic Icons</h3>
                <p className="mb-2">
                  Simply beautiful open source icons. For more information
                  <a href="https://ionicons.com" target='blank'> click here
                  </a>
                  .
                </p>
                <p>
                ...
                <div className="icons-list-wrap">
                  <ul className="icons-list">
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ionic-arrow-up</Tooltip>}>
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-right-a" title="ion-arrow-right-a" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-down-a" title="ion-arrow-down-a" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-left-a" title="ion-arrow-left-a" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-right-b" title="ion-arrow-right-b" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-down-b" title="ion-arrow-down-b" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-left-b" title="ion-arrow-left-b" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-right-c" title="ion-arrow-right-c" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-down-c" title="ion-arrow-down-c" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-left-c" title="ion-arrow-left-c" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-return-right" title="ion-arrow-return-right" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-return-left" title="ion-arrow-return-left" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-shrink" title="ion-arrow-shrink" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-expand" title="ion-arrow-expand" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-resize" title="ion-arrow-resize" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-chevron-right" title="ion-chevron-right" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-chevron-down" title="ion-chevron-down" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-chevron-left" title="ion-chevron-left" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-navicon-round" title="ion-navicon-round" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-checkmark-round" title="ion-checkmark-round" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-checkmark-circled" title="ion-checkmark-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-close-round" title="ion-close-round" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-close-circled" title="ion-close-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-plus-circled" title="ion-plus-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-minus-round" title="ion-minus-round" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-minus-circled" title="ion-minus-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-information" title="ion-information" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-information-circled" title="ion-information-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-help-circled" title="ion-help-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-alert-circled" title="ion-alert-circled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-heart-broken" title="ion-heart-broken" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-toggle-filled" title="ion-toggle-filled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-document-text" title="ion-document-text" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-paper-airplane" title="ion-paper-airplane" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>{`ion-at" `}data-bs-toggle</Tooltip>}>
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-graph-up-right" title="ion-arrow-graph-up-right" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-arrow-graph-down-right</Tooltip>}>
                        <i className="ion-arrow-graph-down-right" title="ion-arrow-graph-down-right" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-arrow-graph-down-left" title="ion-arrow-graph-down-left" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-connection-bars" title="ion-connection-bars" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-chatbubble-working" title="ion-chatbubble-working" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-chatbubbles" title="ion-chatbubbles" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-chatbox-working" title="ion-chatbox-working" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-person-stalker" title="ion-person-stalker" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-battery-full" title="ion-battery-full" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-battery-half" title="ion-battery-half" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-battery-low" title="ion-battery-low" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-battery-empty" title="ion-battery-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-battery-charging" title="ion-battery-charging" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-eye-disabled" title="ion-eye-disabled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-code-working" title="ion-code-working" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-code-download" title="ion-code-download" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-pull-request" title="ion-pull-request" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-game-controller-a" title="ion-game-controller-a" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-game-controller-b" title="ion-game-controller-b" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-playstation" title="ion-playstation" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-closed-captioning" title="ion-closed-captioning" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-videocamera" title="ion-videocamera" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-film-marker" title="ion-film-marker" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-radio-waves" title="ion-radio-waves" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-speakerphone" title="ion-speakerphone" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-volume-high" title="ion-volume-high" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-volume-medium" title="ion-volume-medium" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-volume-mute" title="ion-volume-mute" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-skip-forward" title="ion-skip-forward" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-skip-backward" title="ion-skip-backward" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-thermometer" title="ion-thermometer" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-speedometer" title="ion-speedometer" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-ionic-outline" title="ion-ios7-ionic-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-back" title="ion-ios7-arrow-back" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-forward" title="ion-ios7-arrow-forward" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-up" title="ion-ios7-arrow-up" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-right" title="ion-ios7-arrow-right" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-down" title="ion-ios7-arrow-down" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-left" title="ion-ios7-arrow-left" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-thin-up" title="ion-ios7-arrow-thin-up" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-thin-right" title="ion-ios7-arrow-thin-right" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-thin-down" title="ion-ios7-arrow-thin-down" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-arrow-thin-left" title="ion-ios7-arrow-thin-left" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-circle-filled" title="ion-ios7-circle-filled" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-circle-outline" title="ion-ios7-circle-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-checkmark-empty" title="ion-ios7-checkmark-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-ios7-checkmark-outline</Tooltip>}>
                        <i className="ion-ios7-checkmark-outline" title="ion-ios7-checkmark-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-checkmark" title="ion-ios7-checkmark" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-plus-empty" title="ion-ios7-plus-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-plus-outline" title="ion-ios7-plus-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-close-empty" title="ion-ios7-close-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-close-outline" title="ion-ios7-close-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-minus-empty" title="ion-ios7-minus-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-minus-outline" title="ion-ios7-minus-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-ios7-information-empty</Tooltip>}>
                        <i className="ion-ios7-information-empty" title="ion-ios7-information-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-ios7-information-outline</Tooltip>}>
                        <i className="ion-ios7-information-outline" title="ion-ios7-information-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-information" title="ion-ios7-information" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-help-empty" title="ion-ios7-help-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-help-outline" title="ion-ios7-help-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-search" title="ion-ios7-search" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-search-strong" title="ion-ios7-search-strong" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-star-half" title="ion-ios7-star-half" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-star-outline" title="ion-ios7-star-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-heart-outline" title="ion-ios7-heart-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-more-outline" title="ion-ios7-more-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-home-outline" title="ion-ios7-home-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-cloud-outline" title="ion-ios7-cloud-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-cloud-upload" title="ion-ios7-cloud-upload" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-ios7-cloud-upload-outline</Tooltip>}>
                        <i className="ion-ios7-cloud-upload-outline" title="ion-ios7-cloud-upload-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-cloud-download" title="ion-ios7-cloud-download" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-ios7-cloud-download-outline</Tooltip>}>
                        <i className="ion-ios7-cloud-download-outline" title="ion-ios7-cloud-download-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-upload" title="ion-ios7-upload" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-upload-outline" title="ion-ios7-upload-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-download" title="ion-ios7-download" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-refresh" title="ion-ios7-refresh" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-refresh-outline" title="ion-ios7-refresh-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-refresh-empty" title="ion-ios7-refresh-empty" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-reload" title="ion-ios7-reload" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-loop-strong" title="ion-ios7-loop-strong" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        ...
                        <i className="ion-ios7-bookmarks" title="ion-ios7-bookmarks" ></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>ion-ios7-bookmarks-outline</Tooltip>}>
                        <i className="ion-ios7-bookmarks-outline" title="ion-ios7-bookmarks-outline" ></i>
                      </OverlayTrigger>
                    </li>
                    <li></li>
                    <li></li>
