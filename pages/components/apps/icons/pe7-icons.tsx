...
const Pe7Icons = () => {
  return (
    ...
    <PageHeader title="Pe7 Icons" item="Icons" active_item="Pe7 Icons"/>
        ...
        <Card.Body>
          <Row className="row-sm">
            <Col lg={12} sm={12} className="mb-4">
              <h3 className="main-content-label">Pe7 Icons</h3>
              <p className="mb-2">
                Simply beautiful open source icons. For more info
                <a href="https://themes-pixeden.com/font-demos/7-stroke/"> click here
                </a>
                .
              </p>
              <p>
              ...
              <div className="icons-list-wrap">
                <ul className="icons-list">
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-pendrive" title="pe-7s-pendrive"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-settings" title="pe-7s-settings"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-angle-up" title="pe-7s-angle-up"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    <OverlayTrigger
                      placement="top"
                      overlay={
                        <Tooltip>{`pe-7s-angle-right-circle"`}
                        </Tooltip>
                      }
                    >
                      <i
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-up-arrow" title="pe-7s-up-arrow"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    <OverlayTrigger
                      placement="top"
                      overlay={
                        <Tooltip>pe-7s-scissors</Tooltip>
                      }
                    >
                      <i className="pe-7s-scissors" title="pe-7s-scissors"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>{`safe" title="pe-7s-safe`}</Tooltip>}
                    >
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-volume2" title="pe-7s-volume2"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>{`volume1" title="pe-7s-volume1`}</Tooltip>}
                    >
                      <i className="pe-7s-volume1" title="pe-7s-volume1"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>{`user" title="pe-7s-user`}</Tooltip>}
                    >
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-umbrella" title="pe-7s-umbrella"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-speaker" title="pe-7s-speaker"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-shuffle" title="pe-7s-shuffle"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-shopbag" title="pe-7s-shopbag"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-science" title="pe-7s-science"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-refresh" title="pe-7s-refresh"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-add-user" title="pe-7s-add-user"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    <OverlayTrigger
                      placement="top"
                      overlay={
                        <Tooltip>{`paperclip" title="pe-7s-paperclip`}</Tooltip>
                      }
                    >
                      <i
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-network" title="pe-7s-network"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-notebook" title="pe-7s-notebook"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-monitor" title="pe-7s-monitor"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-lintern" title="pe-7s-lintern"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-glasses" title="pe-7s-glasses"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-expand1" title="pe-7s-expand1"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-exapnd2" title="pe-7s-exapnd2"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-download" title="pe-7s-download"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-display2" title="pe-7s-display2"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-display1" title="pe-7s-display1"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-diskette" title="pe-7s-diskette"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-culture" title="pe-7s-culture"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-compass" title="pe-7s-compass"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                    ...
                    >
                      <i className="pe-7s-comment" title="pe-7s-comment"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-browser" title="pe-7s-browser"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-bicycle" title="pe-7s-bicycle"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-battery" title="pe-7s-battery"></i>
                    </OverlayTrigger>
                  </li>
                  <li className="icons-list-item">
                    <OverlayTrigger
                  ...
                  <li className="icons-list-item">
                    ...
                    >
                      <i className="pe-7s-airplay" title="pe-7s-airplay"></i>
                    </OverlayTrigger>
                  </li>
                  <li></li>
                  <li></li>
