...
const AccordionSummary = styled((props:AccordionSummaryProps) => (
  ...
  (({ theme }) => ({
    backgroundColor: theme.palette.mode === "dark" ? "rgba(255, 255, 255, .05)" : "rgba(0, 0, 0, .03)", flexDirection: "row-reverse",
...
export function CustomizedAccordions() {
  const [expanded, setExpanded] = React.useState<boolean | string>("panel1");
